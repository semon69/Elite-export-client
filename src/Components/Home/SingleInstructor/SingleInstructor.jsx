...
const SingleInstructor = ({ singleInstructor }) => {
  ...
  return (
    <div
      ...
      data-aos="zoom-in"
      className="relative overflow-hidden !duration-700 transition-all  h-[340px] px-2 pt-2 rounded"
    >
      <div className="border-2 p-2 shadow-xl my-4 h-[400px] rounded md:w-[320px]">
        <img className="w-full md:w-[300px] h-[220px] rounded-2xl mx-auto" src={image} alt="" />
        {/* <p className="p-2">
      ...
      <div
        className={`flex justify-center z-10 items-center relative ${hover ? "bottom-52" : "-bottom-32"
          } duration-700   gap-3`}
      >
        <div
          className={`text-center  font-semibold mt-5 relative ${hover ? "bottom-0" : "-bottom-32"
        ...
        >
          ...
          <div className="flex gap-3 justify-center items-center">
            ...
            <a className="cursor-pointer text-red-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
      ...
      <div
        className={`bg-zinc-600 opacity-60 absolute top-0  left-0 right-0 ${hover ? "bottom-0" : ""
          } !duration-500 `}
      ></div>
    </div>
  );
