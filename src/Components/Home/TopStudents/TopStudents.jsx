            ...
            <div className="md:flex gap-5">
              ...
              <div className="p-6 md:pr-20 space-y-4">
                ...
                <p className="font-bold text-2xl">
                  Current Club:{" "}
                  <span className="text-green-500">{player.currentClub}</span>
                </p>
                <div className="md:flex justify-between font-bold text-2xl ">
                  <p>
                    Nationality:{" "}
                    <span className="text-green-500">{player.country}</span>
                  </p>
                  <p>
                    Career Goals:{" "}
                    <span className="text-green-500">{player.goals}</span>
                  </p>
                </div>
                <p>{player.about}</p>
                <button className="border p-2 bg-green-500 text-white font-bold rounded">
                  {" "}
                  <Link to={player.link}>
                    See More About: {player.name.split(" ")[0]}
                  </Link>
                </button>
              </div>
            </div>
